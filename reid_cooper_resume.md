...
- **Entitlement Service -- First Golang Microservice**: Designed and built Teachable's first Golang microservice, achieving an average 2ms response time and 27k+ requests per minute -- the second-highest throughput application in the stack. Integrated with Chargebee for structured, consistent school plan management across the platform.
