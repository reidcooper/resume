...
- **B2B Product Team Lead**: Led a 5-engineer team delivering Teachable's B2B offering from zero to production under a crucial, strict end-of-November deadline. Drove end-to-end ownership: product engineering roadmap, system architecture within a legacy monolith, cross-functional project facilitation, and hands-on technical guidance for engineers. Delivered on time in November 2025 -- a full 0-to-production effort in under 4 months.
- **File Migration Tiger Team**: Led a 5-engineer tiger team migrating all Teachable-hosted files and content away from a third-party vendor under a strict 9-week deadline, working 80+ hours per week. Designed performant migration scripts spanning 5 repositories -- covering 30M+ database record updates across 45+ table/column pairs, file integrity validation, reference integrity, rich text parsing, and consistent upload patterns across 56+ locations. Successfully migrated 15 million files on time. (*TODO: add cost savings*)
...
- **Plan Service Adoption**: With SLT support, led an initiative for all product engineering teams to migrate their domains to a centralized school capabilities service -- decoupling the platform from hard-coded plan names and establishing a flexible foundation for future subscription tiers.
- **Revenue Initiatives**: Introduced two new revenue streams: Plan Addons and One-Time Purchases. Designed and implemented both using state machine and monadic patterns for reliability, recoverability, and ease of maintenance -- Plan Addons spanning two services. (*TODO: locate revenue impact*)
...
- **Video Platform Migration**: Led the full lifecycle of Teachable's student video platform migration from Wistia to an in-house video player -- redesigning integrations across 5+ products, maintaining full course compliance system integrity, and executing the end-to-end migration of 8 million video assets.
...
- **Kane Brewery Management System**: Full-stack Rails brewery management system for tracking in-progress and finished product inventory -- a cost-effective solution for small-scale breweries and wineries.
